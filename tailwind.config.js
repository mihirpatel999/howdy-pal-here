  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-hero': 'linear-gradient(135deg, hsl(var(--primary-500)), hsl(var(--primary-700)), hsl(var(--accent)))',
      ...
      boxShadow: {
        ...
        'floating': '0 8px 32px -8px hsl(var(--primary) / 0.25)',
        'glow': '0 0 40px hsl(var(--primary) / 0.4)',
        'inner-glow': 'inset 0 2px 8px hsl(var(--primary) / 0.1)',
      },
      animation: {
